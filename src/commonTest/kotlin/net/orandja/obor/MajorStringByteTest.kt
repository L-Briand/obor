...
class MajorStringByteTest {
    ...
    companion object {
        ...
        val CBOR_EMPTY_INDEFINITE = buildChunkedIndefinite(MAJOR_BYTE, 0, 10)

        // 1 ITEM
        val ONE: ByteArray = byteArrayOf(0)
        val CBOR_ONE = buildSize(MAJOR_BYTE, 1)
        val CBOR_ONE_INDEFINITE_x10 = buildChunkedIndefinite(MAJOR_BYTE, 1, 10)
        val CBOR_ONE_INDEFINITE_x255 = buildChunkedIndefinite(MAJOR_BYTE, 1, 255)

        // 23 ITEMS
        val MAX_SIZE0: ByteArray = ByteArray(0x17)
        val CBOR_MAX_SIZE0: ByteArray = buildSize(MAJOR_BYTE, 0x17)
        val CBOR_MAX_SIZE0_INDEFINITE_x10: ByteArray = buildChunkedIndefinite(MAJOR_BYTE, 0x17, 10)
        val CBOR_MAX_SIZE0_INDEFINITE_x255: ByteArray = buildChunkedIndefinite(MAJOR_BYTE, 0x17, 255)

        // 24 ITEMS
        val MIN_SIZE8: ByteArray = ByteArray(0x18)
        val CBOR_MIN_SIZE8 = buildSize(MAJOR_BYTE, 0x18)
        val CBOR_MIN_SIZE8_INDEFINITE_x10 = buildChunkedIndefinite(MAJOR_BYTE, 0x18, 10)
        val CBOR_MIN_SIZE8_INDEFINITE_x255 = buildChunkedIndefinite(MAJOR_BYTE, 0x18, 255)

        // 255 ITEMS
        val MAX_SIZE8: ByteArray = ByteArray(0xFF)
        val CBOR_MAX_SIZE8 = buildSize(MAJOR_BYTE, 0xFF)
        val CBOR_MAX_SIZE8_INDEFINITE_x10 = buildChunkedIndefinite(MAJOR_BYTE, 0xFF, 10)
        val CBOR_MAX_SIZE8_INDEFINITE_x255 = buildChunkedIndefinite(MAJOR_BYTE, 0xFF, 0xFF)

        // 257 ITEMS
        val MIN_SIZE16: ByteArray = ByteArray(0x100)
        val CBOR_MIN_SIZE16 = buildSize(MAJOR_BYTE, 0x100)
        val CBOR_MIN_SIZE16_INDEFINITE_x10 = buildChunkedIndefinite(MAJOR_BYTE, 0x100, 10)
        val CBOR_MIN_SIZE16_INDEFINITE_x255 = buildChunkedIndefinite(MAJOR_BYTE, 0x100, 0xFF)
    }
    ...
    @Serializable
    data class Bytes2(@CborIndefinite @CborRawBytes val bytes: ByteArray) {
        override fun hashCode(): Int = bytes.contentHashCode()
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
    ...
    @Serializable
    data class BytesArray2(@CborIndefinite @CborRawBytes val bytes: Array<Byte>) {
        override fun hashCode(): Int = bytes.contentHashCode()
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
    ...
    @Serializable
    data class BytesList2(@CborIndefinite @CborRawBytes val bytes: List<Byte>)
    ...
    fun listByteArray() {
        ...
        fun assertIndefiniteEquals(data: List<ByteArray>, cbor: ByteArray) {
        ...
        assertContentEquals(EMPTY, CBOR_EMPTY_INDEFINITE decodeCbor CborByteArraySerializer)
        assertContentEquals(ONE, CBOR_ONE_INDEFINITE_x10 decodeCbor CborByteArraySerializer)
        assertContentEquals(MAX_SIZE0, CBOR_MAX_SIZE0_INDEFINITE_x10 decodeCbor CborByteArraySerializer)
        assertContentEquals(MIN_SIZE8, CBOR_MIN_SIZE8_INDEFINITE_x10 decodeCbor CborByteArraySerializer)
        assertContentEquals(MAX_SIZE8, CBOR_MAX_SIZE8_INDEFINITE_x10 decodeCbor CborByteArraySerializer)
        assertContentEquals(MIN_SIZE16, CBOR_MIN_SIZE16_INDEFINITE_x10 decodeCbor CborByteArraySerializer)
    }

    @Test
    fun arrayByteArray() {

        fun assertIndefiniteEquals(data: Array<ByteArray>, cbor: ByteArray) {
    ...
    @Test
    fun classBytes2() {
        assertEquals(Bytes2(EMPTY), cborInClass(CBOR_EMPTY_INDEFINITE) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_EMPTY_INDEFINITE), Bytes2(EMPTY) encodeCbor serializer())

        assertEquals(Bytes2(ONE), cborInClass(CBOR_ONE_INDEFINITE_x255) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_ONE_INDEFINITE_x255), Bytes2(ONE) encodeCbor serializer())

        assertEquals(Bytes2(MAX_SIZE0), cborInClass(CBOR_MAX_SIZE0_INDEFINITE_x255) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_MAX_SIZE0_INDEFINITE_x255), Bytes2(MAX_SIZE0) encodeCbor serializer())

        assertEquals(Bytes2(MIN_SIZE8), cborInClass(CBOR_MIN_SIZE8_INDEFINITE_x255) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_MIN_SIZE8_INDEFINITE_x255), Bytes2(MIN_SIZE8) encodeCbor serializer())

        assertEquals(Bytes2(MAX_SIZE8), cborInClass(CBOR_MAX_SIZE8_INDEFINITE_x255) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_MAX_SIZE8_INDEFINITE_x255), Bytes2(MAX_SIZE8) encodeCbor serializer())

        assertEquals(Bytes2(MIN_SIZE16), cborInClass(CBOR_MIN_SIZE16_INDEFINITE_x255) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_MIN_SIZE16_INDEFINITE_x255), Bytes2(MIN_SIZE16) encodeCbor serializer())
    }
    ...
    fun classBytesArray2() {
        ...
        assertContentEquals(
            cborInClass(CBOR_ONE_INDEFINITE_x255),
        ...
        assertEquals(
            ...
            cborInClass(CBOR_MIN_SIZE16_INDEFINITE_x255) decodeCbor serializer()
        )
        assertContentEquals(
    ...
    @Test
    fun classBytesList2() {
        assertEquals(BytesList2(EMPTY.toList()), cborInClass(CBOR_EMPTY_INDEFINITE) decodeCbor serializer())
        assertContentEquals(cborInClass(CBOR_EMPTY_INDEFINITE), BytesList2(EMPTY.toList()) encodeCbor serializer())
